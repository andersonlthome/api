...
function RegisterRoutes(app) {
    ...
    // ###########################################################################################################
    app.get('/api/v1', ...((0, runtime_1.fetchMiddlewares)(index_controller_1.IndexController)), ...((0, runtime_1.fetchMiddlewares)(index_controller_1.IndexController.prototype.index)), function IndexController_index(request, response, next) {
        const args = {};
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        let validatedArgs = [];
        try {
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.get('/api/v1/msg', ...((0, runtime_1.fetchMiddlewares)(index_controller_1.IndexController)), ...((0, runtime_1.fetchMiddlewares)(index_controller_1.IndexController.prototype.msg)), function IndexController_msg(request, response, next) {
        const args = {};
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        let validatedArgs = [];
        try {
